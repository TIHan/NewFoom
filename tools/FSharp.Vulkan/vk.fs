...
type VkImageLayout =
    ...
    | VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_OPTIMAL = 1000241000u
    | VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_OPTIMAL = 1000241001u
    | VK_IMAGE_LAYOUT_STENCIL_ATTACHMENT_OPTIMAL = 1000241002u
    | VK_IMAGE_LAYOUT_STENCIL_READ_ONLY_OPTIMAL = 1000241003u
    | VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_OPTIMAL_KHR = 1000241000u
    | VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_STENCIL_READ_ONLY_OPTIMAL_KHR = 1000117001u
    | VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_OPTIMAL_KHR = 1000241001u
    | VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_STENCIL_ATTACHMENT_OPTIMAL_KHR = 1000117000u
    | VK_IMAGE_LAYOUT_STENCIL_ATTACHMENT_OPTIMAL_KHR = 1000241002u
    | VK_IMAGE_LAYOUT_STENCIL_READ_ONLY_OPTIMAL_KHR = 1000241003u
...
type VkQueryType =
    ...
    | VK_QUERY_TYPE_PERFORMANCE_QUERY_KHR = 1000116000u
...
type VkStructureType =
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT16_INT8_FEATURES = 1000082000u
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGELESS_FRAMEBUFFER_FEATURES = 1000108000u
    | VK_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENTS_CREATE_INFO = 1000108001u
    | VK_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENT_IMAGE_INFO = 1000108002u
    | VK_STRUCTURE_TYPE_RENDER_PASS_ATTACHMENT_BEGIN_INFO = 1000108003u
    | VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_2 = 1000109000u
    | VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_2 = 1000109001u
    | VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_2 = 1000109002u
    | VK_STRUCTURE_TYPE_SUBPASS_DEPENDENCY_2 = 1000109003u
    | VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO_2 = 1000109004u
    | VK_STRUCTURE_TYPE_SUBPASS_BEGIN_INFO = 1000109005u
    | VK_STRUCTURE_TYPE_SUBPASS_END_INFO = 1000109006u
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PERFORMANCE_QUERY_FEATURES_KHR = 1000116000u
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PERFORMANCE_QUERY_PROPERTIES_KHR = 1000116001u
    | VK_STRUCTURE_TYPE_QUERY_POOL_PERFORMANCE_CREATE_INFO_KHR = 1000116002u
    | VK_STRUCTURE_TYPE_PERFORMANCE_QUERY_SUBMIT_INFO_KHR = 1000116003u
    | VK_STRUCTURE_TYPE_ACQUIRE_PROFILING_LOCK_INFO_KHR = 1000116004u
    | VK_STRUCTURE_TYPE_PERFORMANCE_COUNTER_KHR = 1000116005u
    | VK_STRUCTURE_TYPE_PERFORMANCE_COUNTER_DESCRIPTION_KHR = 1000116006u
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_FILTER_MINMAX_PROPERTIES = 1000130000u
    | VK_STRUCTURE_TYPE_SAMPLER_REDUCTION_MODE_CREATE_INFO = 1000130001u
    ...
    | VK_STRUCTURE_TYPE_IMAGE_FORMAT_LIST_CREATE_INFO = 1000147000u
    ...
    | VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_BINDING_FLAGS_CREATE_INFO = 1000161000u
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES = 1000161001u
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES = 1000161002u
    | VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_ALLOCATE_INFO = 1000161003u
    | VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_LAYOUT_SUPPORT = 1000161004u
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_EXTENDED_TYPES_FEATURES = 1000175000u
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES = 1000177000u
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_INT64_FEATURES = 1000180000u
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CLOCK_FEATURES_KHR = 1000181000u
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DRIVER_PROPERTIES = 1000196000u
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT_CONTROLS_PROPERTIES = 1000197000u
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_STENCIL_RESOLVE_PROPERTIES = 1000199000u
    | VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE = 1000199001u
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_FEATURES = 1000207000u
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES = 1000207001u
    | VK_STRUCTURE_TYPE_SEMAPHORE_TYPE_CREATE_INFO = 1000207002u
    | VK_STRUCTURE_TYPE_TIMELINE_SEMAPHORE_SUBMIT_INFO = 1000207003u
    | VK_STRUCTURE_TYPE_SEMAPHORE_WAIT_INFO = 1000207004u
    | VK_STRUCTURE_TYPE_SEMAPHORE_SIGNAL_INFO = 1000207005u
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_MEMORY_MODEL_FEATURES = 1000211000u
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES = 1000221000u
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SEPARATE_DEPTH_STENCIL_LAYOUTS_FEATURES = 1000241000u
    | VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_STENCIL_LAYOUT = 1000241001u
    | VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_STENCIL_LAYOUT = 1000241002u
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES_EXT = 1000244000u
    | VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_INFO = 1000244001u
    | VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_CREATE_INFO_EXT = 1000244002u
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TOOL_PROPERTIES_EXT = 1000245000u
    | VK_STRUCTURE_TYPE_IMAGE_STENCIL_USAGE_CREATE_INFO = 1000246000u
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_UNIFORM_BUFFER_STANDARD_LAYOUT_FEATURES = 1000253000u
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES = 1000257000u
    | VK_STRUCTURE_TYPE_BUFFER_OPAQUE_CAPTURE_ADDRESS_CREATE_INFO = 1000257002u
    | VK_STRUCTURE_TYPE_MEMORY_OPAQUE_CAPTURE_ADDRESS_ALLOCATE_INFO = 1000257003u
    | VK_STRUCTURE_TYPE_DEVICE_MEMORY_OPAQUE_CAPTURE_ADDRESS_INFO = 1000257004u
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_QUERY_RESET_FEATURES = 1000261000u
    ...
    | VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_RENDER_PASS_TRANSFORM_INFO_QCOM = 1000282000u
    | VK_STRUCTURE_TYPE_RENDER_PASS_TRANSFORM_BEGIN_INFO_QCOM = 1000282001u
    | VK_STRUCTURE_TYPE_RESERVED_QCOM = 1000309000u
    | VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_2_KHR = 1000109000u
    | VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_STENCIL_LAYOUT_KHR = 1000241002u
    | VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_2_KHR = 1000109001u
    | VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_STENCIL_LAYOUT_KHR = 1000241001u
    ...
    | VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_INFO_KHR = 1000244001u
    | VK_STRUCTURE_TYPE_BUFFER_MEMORY_REQUIREMENTS_INFO_2_KHR = 1000146000u
    | VK_STRUCTURE_TYPE_BUFFER_OPAQUE_CAPTURE_ADDRESS_CREATE_INFO_KHR = 1000257002u
    ...
    | VK_STRUCTURE_TYPE_DEVICE_MEMORY_OPAQUE_CAPTURE_ADDRESS_INFO_KHR = 1000257004u
    ...
    | VK_STRUCTURE_TYPE_MEMORY_OPAQUE_CAPTURE_ADDRESS_ALLOCATE_INFO_KHR = 1000257003u
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES_KHR = 1000257000u
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SEPARATE_DEPTH_STENCIL_LAYOUTS_FEATURES_KHR = 1000241000u
    ...
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_EXTENDED_TYPES_FEATURES_KHR = 1000175000u
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SPARSE_IMAGE_FORMAT_INFO_2_KHR = 1000059008u
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_FEATURES_KHR = 1000207000u
    | VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES_KHR = 1000207001u
    ...
    | VK_STRUCTURE_TYPE_SEMAPHORE_SIGNAL_INFO_KHR = 1000207005u
    | VK_STRUCTURE_TYPE_SEMAPHORE_TYPE_CREATE_INFO_KHR = 1000207002u
    | VK_STRUCTURE_TYPE_SEMAPHORE_WAIT_INFO_KHR = 1000207004u
    ...
    | VK_STRUCTURE_TYPE_TIMELINE_SEMAPHORE_SUBMIT_INFO_KHR = 1000207003u
...
type VkResult =
    ...
    | VK_RESULT_EXT_298_RESERVED_VALUE_0_EXT = 1000297000u
    | VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS = 3294710296u
    | VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT = 3294712296u
    | VK_ERROR_NOT_PERMITTED_EXT = 3294793295u
    | VK_ERROR_FRAGMENTATION = 3294806296u
    ...
    | VK_ERROR_INVALID_DEVICE_ADDRESS_EXT = 3294710296u
    | VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS_KHR = 3294710296u
...
type VkRenderPassCreateFlagBits =
    ...
    | VK_RENDER_PASS_CREATE_TRANSFORM_BIT_QCOM = 2u
...
type VkMemoryHeapFlagBits =
    ...
    | VK_MEMORY_HEAP_RESERVED_2_BIT_KHR = 4u
...
type VkBufferUsageFlagBits =
    ...
    | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT = 131072u
    | VK_BUFFER_USAGE_RESERVED_18_BIT_QCOM = 262144u
    | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT_EXT = 131072u
    | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT_KHR = 131072u
...
type VkBufferCreateFlagBits =
    ...
    | VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT = 16u
    | VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_EXT = 16u
    | VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR = 16u
...
type VkImageUsageFlagBits =
    ...
    | VK_IMAGE_USAGE_RESERVED_16_BIT_QCOM = 65536u
    | VK_IMAGE_USAGE_RESERVED_17_BIT_QCOM = 131072u
...
type VkPipelineCreateFlagBits =
    ...
    | VK_PIPELINE_CREATE_DISPATCH_BASE_BIT = 16u
    ...
    | VK_PIPELINE_CREATE_RESERVED_8_BIT_EXT = 256u
    | VK_PIPELINE_CREATE_RESERVED_9_BIT_EXT = 512u
    | VK_PIPELINE_CREATE_RESERVED_10_BIT_EXT = 1024u
    | VK_PIPELINE_CREATE_EXTENSION_151_BIT0_NV = 2048u
    | VK_PIPELINE_CREATE_EXTENSION_291_BIT0_NV = 4096u
    | VK_PIPELINE_CREATE_EXTENSION_291_BIT1_NV = 8192u
    | VK_PIPELINE_CREATE_EXTENSION_151_BIT1_NV = 16384u
    | VK_PIPELINE_CREATE_EXTENSION_151_BIT2_NV = 32768u
    | VK_PIPELINE_CREATE_EXTENSION_151_BIT3_NV = 65536u
    | VK_PIPELINE_CREATE_EXTENSION_151_BIT4_NV = 131072u
    | VK_PIPELINE_CREATE_EXTENSION_278_BIT18_NV = 262144u
...
type VkPipelineShaderStageCreateFlagBits =
    ...
    | VK_PIPELINE_SHADER_STAGE_CREATE_RESERVED_3_BIT_KHR = 8u
...
type VkSemaphoreCreateFlagBits = uint32
...
type VkFormatFeatureFlagBits =
    ...
    | VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_MINMAX_BIT = 65536u
    ...
    | VK_FORMAT_FEATURE_RESERVED_29_BIT_NV = 536870912u
...
type VkDescriptorPoolCreateFlagBits =
    ...
    | VK_DESCRIPTOR_POOL_CREATE_UPDATE_AFTER_BIND_BIT = 2u
...
type VkSemaphoreType =
    | VK_SEMAPHORE_TYPE_BINARY = 0u
    | VK_SEMAPHORE_TYPE_TIMELINE = 1u
    | VK_SEMAPHORE_TYPE_BINARY_KHR = 0u
    | VK_SEMAPHORE_TYPE_TIMELINE_KHR = 1u

type VkSemaphoreWaitFlagBits =
    | VK_SEMAPHORE_WAIT_ANY_BIT = 1u
    | VK_SEMAPHORE_WAIT_ANY_BIT_KHR = 1u
...
type VkDescriptorSetLayoutCreateFlagBits =
    ...
    | VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT = 2u
...
type VkMemoryAllocateFlagBits =
    ...
    | VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT = 2u
    | VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT = 4u
    | VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT_KHR = 2u
    | VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR = 4u
...
type VkSamplerReductionMode =
    | VK_SAMPLER_REDUCTION_MODE_WEIGHTED_AVERAGE = 0u
    | VK_SAMPLER_REDUCTION_MODE_MIN = 1u
    | VK_SAMPLER_REDUCTION_MODE_MAX = 2u
...
type VkDescriptorBindingFlagBits =
    | VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT = 1u
    | VK_DESCRIPTOR_BINDING_UPDATE_UNUSED_WHILE_PENDING_BIT = 2u
    | VK_DESCRIPTOR_BINDING_PARTIALLY_BOUND_BIT = 4u
    | VK_DESCRIPTOR_BINDING_VARIABLE_DESCRIPTOR_COUNT_BIT = 8u
...
type VkVendorId =
    ...
    | VK_VENDOR_ID_CODEPLAY = 65540u

type VkDriverId =
    /// Advanced Micro Devices, Inc.
    | VK_DRIVER_ID_AMD_PROPRIETARY = 1u
    /// Advanced Micro Devices, Inc.
    | VK_DRIVER_ID_AMD_OPEN_SOURCE = 2u
    /// Mesa open source project
    | VK_DRIVER_ID_MESA_RADV = 3u
    /// NVIDIA Corporation
    | VK_DRIVER_ID_NVIDIA_PROPRIETARY = 4u
    /// Intel Corporation
    | VK_DRIVER_ID_INTEL_PROPRIETARY_WINDOWS = 5u
    /// Intel Corporation
    | VK_DRIVER_ID_INTEL_OPEN_SOURCE_MESA = 6u
    /// Imagination Technologies
    | VK_DRIVER_ID_IMAGINATION_PROPRIETARY = 7u
    /// Qualcomm Technologies, Inc.
    | VK_DRIVER_ID_QUALCOMM_PROPRIETARY = 8u
    /// Arm Limited
    | VK_DRIVER_ID_ARM_PROPRIETARY = 9u
    /// Google LLC
    | VK_DRIVER_ID_GOOGLE_SWIFTSHADER = 10u
    /// Google LLC
    | VK_DRIVER_ID_GGP_PROPRIETARY = 11u
    /// Broadcom Inc.
    | VK_DRIVER_ID_BROADCOM_PROPRIETARY = 12u
...
type VkResolveModeFlagBits =
    | VK_RESOLVE_MODE_NONE = 0u
    | VK_RESOLVE_MODE_SAMPLE_ZERO_BIT = 1u
    | VK_RESOLVE_MODE_AVERAGE_BIT = 2u
    | VK_RESOLVE_MODE_MIN_BIT = 4u
    | VK_RESOLVE_MODE_MAX_BIT = 8u
...
type VkFramebufferCreateFlagBits =
    | VK_FRAMEBUFFER_CREATE_IMAGELESS_BIT = 1u
...
type VkPerformanceCounterScopeKHR =
    | VK_PERFORMANCE_COUNTER_SCOPE_COMMAND_BUFFER_KHR = 0u
    | VK_PERFORMANCE_COUNTER_SCOPE_RENDER_PASS_KHR = 1u
    | VK_PERFORMANCE_COUNTER_SCOPE_COMMAND_KHR = 2u

type VkPerformanceCounterUnitKHR =
    | VK_PERFORMANCE_COUNTER_UNIT_GENERIC_KHR = 0u
    | VK_PERFORMANCE_COUNTER_UNIT_PERCENTAGE_KHR = 1u
    | VK_PERFORMANCE_COUNTER_UNIT_NANOSECONDS_KHR = 2u
    | VK_PERFORMANCE_COUNTER_UNIT_BYTES_KHR = 3u
    | VK_PERFORMANCE_COUNTER_UNIT_BYTES_PER_SECOND_KHR = 4u
    | VK_PERFORMANCE_COUNTER_UNIT_KELVIN_KHR = 5u
    | VK_PERFORMANCE_COUNTER_UNIT_WATTS_KHR = 6u
    | VK_PERFORMANCE_COUNTER_UNIT_VOLTS_KHR = 7u
    | VK_PERFORMANCE_COUNTER_UNIT_AMPS_KHR = 8u
    | VK_PERFORMANCE_COUNTER_UNIT_HERTZ_KHR = 9u
    | VK_PERFORMANCE_COUNTER_UNIT_CYCLES_KHR = 10u

type VkPerformanceCounterStorageKHR =
    | VK_PERFORMANCE_COUNTER_STORAGE_INT32_KHR = 0u
    | VK_PERFORMANCE_COUNTER_STORAGE_INT64_KHR = 1u
    | VK_PERFORMANCE_COUNTER_STORAGE_UINT32_KHR = 2u
    | VK_PERFORMANCE_COUNTER_STORAGE_UINT64_KHR = 3u
    | VK_PERFORMANCE_COUNTER_STORAGE_FLOAT32_KHR = 4u
    | VK_PERFORMANCE_COUNTER_STORAGE_FLOAT64_KHR = 5u

type VkPerformanceCounterDescriptionFlagBitsKHR =
    | VK_PERFORMANCE_COUNTER_DESCRIPTION_PERFORMANCE_IMPACTING_KHR = 1u
    | VK_PERFORMANCE_COUNTER_DESCRIPTION_CONCURRENTLY_IMPACTED_KHR = 2u
...
type VkShaderFloatControlsIndependence =
    | VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_32_BIT_ONLY = 0u
    | VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_ALL = 1u
    | VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_NONE = 2u
...
type VkToolPurposeFlagBitsEXT =
    | VK_TOOL_PURPOSE_VALIDATION_BIT_EXT = 1u
    | VK_TOOL_PURPOSE_PROFILING_BIT_EXT = 2u
    | VK_TOOL_PURPOSE_TRACING_BIT_EXT = 4u
    | VK_TOOL_PURPOSE_ADDITIONAL_FEATURES_BIT_EXT = 8u
    | VK_TOOL_PURPOSE_MODIFYING_FEATURES_BIT_EXT = 16u
    | VK_TOOL_PURPOSE_DEBUG_REPORTING_BIT_EXT = 32u
    | VK_TOOL_PURPOSE_DEBUG_MARKERS_BIT_EXT = 64u
...
type VkPhysicalDeviceToolPropertiesEXT =
    ...
    [<DefaultValue(false)>]
    [<FixedBuffer(typeof<byte>, 256)>]
    val mutable version: VkFixedArray_byte_256
    [<DefaultValue(false)>]
    val mutable purposes: VkToolPurposeFlagsEXT
    [<DefaultValue(false)>]
    [<FixedBuffer(typeof<byte>, 256)>]
    val mutable description: VkFixedArray_byte_256
    [<DefaultValue(false)>]
    [<FixedBuffer(typeof<byte>, 256)>]
    val mutable layer: VkFixedArray_byte_256
...
type VkPhysicalDeviceVulkan12Properties =
    ...
    val mutable pNext: nativeint
    [<DefaultValue(false)>]
    val mutable driverID: VkDriverId
    [<DefaultValue(false)>]
    [<FixedBuffer(typeof<byte>, 256)>]
    ...
    [<DefaultValue(false)>]
    val mutable conformanceVersion: VkConformanceVersion
    [<DefaultValue(false)>]
    val mutable denormBehaviorIndependence: VkShaderFloatControlsIndependence
    [<DefaultValue(false)>]
    val mutable roundingModeIndependence: VkShaderFloatControlsIndependence
    ...
    [<DefaultValue(false)>]
    val mutable supportedDepthResolveModes: VkResolveModeFlags
    /// supported stencil resolve modes
    [<DefaultValue(false)>]
    val mutable supportedStencilResolveModes: VkResolveModeFlags
    ...
    [<DefaultValue(false)>]
    val mutable maxTimelineSemaphoreValueDifference: uint64
    [<DefaultValue(false)>]
    val mutable framebufferIntegerColorSampleCounts: VkSampleCountFlags
...
type VkPhysicalDeviceVulkan12Features =
    ...
    val mutable pNext: nativeint
    [<DefaultValue(false)>]
    val mutable samplerMirrorClampToEdge: VkBool32
    [<DefaultValue(false)>]
    val mutable drawIndirectCount: VkBool32
    ...
    [<DefaultValue(false)>]
    val mutable descriptorIndexing: VkBool32
    [<DefaultValue(false)>]
    ...
    [<DefaultValue(false)>]
    val mutable samplerFilterMinmax: VkBool32
    [<DefaultValue(false)>]
    ...
    [<DefaultValue(false)>]
    val mutable shaderSubgroupExtendedTypes: VkBool32
    [<DefaultValue(false)>]
    val mutable separateDepthStencilLayouts: VkBool32
    [<DefaultValue(false)>]
    val mutable hostQueryReset: VkBool32
    [<DefaultValue(false)>]
    val mutable timelineSemaphore: VkBool32
    [<DefaultValue(false)>]
    ...
    [<DefaultValue(false)>]
    val mutable shaderOutputViewportIndex: VkBool32
    [<DefaultValue(false)>]
    val mutable shaderOutputLayer: VkBool32
    [<DefaultValue(false)>]
    val mutable subgroupBroadcastDynamicId: VkBool32
...
type VkPhysicalDeviceVulkan11Properties =
    ...
    [<DefaultValue(false)>]
    val mutable subgroupSupportedStages: VkShaderStageFlags
    /// Bitfield of what subgroup operations are supported.
    [<DefaultValue(false)>]
    val mutable subgroupSupportedOperations: VkSubgroupFeatureFlags
    /// Flag to specify whether quad operations are available in all stages.
    [<DefaultValue(false)>]
    val mutable subgroupQuadOperationsInAllStages: VkBool32
    [<DefaultValue(false)>]
...
type VkMemoryOpaqueCaptureAddressAllocateInfo =
    ...
    val mutable pNext: nativeint
    [<DefaultValue(false)>]
    val mutable opaqueCaptureAddress: uint64
...
type VkAttachmentDescriptionStencilLayout =
    ...
    val mutable pNext: nativeint
    [<DefaultValue(false)>]
    val mutable stencilInitialLayout: VkImageLayout
    [<DefaultValue(false)>]
    val mutable stencilFinalLayout: VkImageLayout
...
type VkAttachmentReferenceStencilLayout =
    ...
    val mutable pNext: nativeint
    [<DefaultValue(false)>]
    val mutable stencilLayout: VkImageLayout
...
type VkPhysicalDeviceShaderClockFeaturesKHR =
    ...
    val mutable pNext: nativeint
    [<DefaultValue(false)>]
    val mutable shaderSubgroupClock: VkBool32
    [<DefaultValue(false)>]
    val mutable shaderDeviceClock: VkBool32
...
type VkPerformanceQuerySubmitInfoKHR =
    ...
    [<DefaultValue(false)>]
    val mutable counterPassIndex: uint32
...
type VkAcquireProfilingLockInfoKHR =
    ...
    [<DefaultValue(false)>]
    val mutable flags: VkAcquireProfilingLockFlagsKHR
    [<DefaultValue(false)>]
...
type VkPerformanceCounterResultKHR =
    ...
    [<FieldOffset(0);DefaultValue(false)>]
    val mutable uint64: uint64
    [<FieldOffset(0);DefaultValue(false)>]
    val mutable float32: float32
    [<FieldOffset(0);DefaultValue(false)>]
    val mutable float64: float
...
type VkQueryPoolPerformanceCreateInfoKHR =
    ...
    [<DefaultValue(false)>]
    val mutable counterIndexCount: uint32
    [<DefaultValue(false)>]
    val mutable pCounterIndices: nativeptr<uint32>
...
type VkPerformanceCounterDescriptionKHR =
    ...
    val mutable pNext: nativeint
    [<DefaultValue(false)>]
    val mutable flags: VkPerformanceCounterDescriptionFlagsKHR
    [<DefaultValue(false)>]
    [<FixedBuffer(typeof<byte>, 256)>]
    val mutable name: VkFixedArray_byte_256
    [<DefaultValue(false)>]
    [<FixedBuffer(typeof<byte>, 256)>]
    val mutable category: VkFixedArray_byte_256
    [<DefaultValue(false)>]
    [<FixedBuffer(typeof<byte>, 256)>]
    val mutable description: VkFixedArray_byte_256
...
type VkPerformanceCounterKHR =
    ...
    val mutable pNext: nativeint
    [<DefaultValue(false)>]
    val mutable unit: VkPerformanceCounterUnitKHR
    [<DefaultValue(false)>]
    val mutable scope: VkPerformanceCounterScopeKHR
    [<DefaultValue(false)>]
    val mutable storage: VkPerformanceCounterStorageKHR
    [<DefaultValue(false)>]
    [<FixedBuffer(typeof<byte>, 16)>]
    val mutable uuid: VkFixedArray_byte_16
...
type VkPhysicalDevicePerformanceQueryPropertiesKHR =
    ...
    [<DefaultValue(false)>]
    val mutable allowCommandBufferQueryCopies: VkBool32
...
type VkPhysicalDevicePerformanceQueryFeaturesKHR =
    ...
    [<DefaultValue(false)>]
    val mutable performanceCounterQueryPools: VkBool32
    /// performance counters from multiple query pools can be accessed in the same primary command buffer
    [<DefaultValue(false)>]
    val mutable performanceCounterMultipleQueryPools: VkBool32
...
type VkFramebufferAttachmentsCreateInfo =
    ...
    [<DefaultValue(false)>]
    val mutable pAttachmentImageInfos: nativeptr<VkFramebufferAttachmentImageInfo>
...
type VkSubpassDescriptionDepthStencilResolve =
    ...
    /// depth resolve mode
    [<DefaultValue(false)>]
    val mutable depthResolveMode: VkResolveModeFlagBits
    /// stencil resolve mode
    [<DefaultValue(false)>]
    val mutable stencilResolveMode: VkResolveModeFlagBits
    /// depth/stencil resolve attachment
    [<DefaultValue(false)>]
    val mutable pDepthStencilResolveAttachment: nativeptr<VkAttachmentReference2>
...
type VkSemaphoreWaitInfo =
    ...
    val mutable pNext: nativeint
    [<DefaultValue(false)>]
    val mutable flags: VkSemaphoreWaitFlags
    [<DefaultValue(false)>]
    val mutable semaphoreCount: uint32
    [<DefaultValue(false)>]
    val mutable pSemaphores: nativeptr<VkSemaphore>
    [<DefaultValue(false)>]
    val mutable pValues: nativeptr<uint64>
...
type VkTimelineSemaphoreSubmitInfo =
    ...
    val mutable pNext: nativeint
    [<DefaultValue(false)>]
    val mutable waitSemaphoreValueCount: uint32
    [<DefaultValue(false)>]
    val mutable pWaitSemaphoreValues: nativeptr<uint64>
    [<DefaultValue(false)>]
    val mutable signalSemaphoreValueCount: uint32
    [<DefaultValue(false)>]
...
type VkSemaphoreTypeCreateInfo =
    ...
    val mutable pNext: nativeint
    [<DefaultValue(false)>]
    val mutable semaphoreType: VkSemaphoreType
    [<DefaultValue(false)>]
    val mutable initialValue: uint64
...
type VkRenderPassCreateInfo2 =
    ...
    val mutable attachmentCount: uint32
    [<DefaultValue(false)>]
    val mutable pAttachments: nativeptr<VkAttachmentDescription2>
    [<DefaultValue(false)>]
    val mutable subpassCount: uint32
    [<DefaultValue(false)>]
    val mutable pSubpasses: nativeptr<VkSubpassDescription2>
    [<DefaultValue(false)>]
    val mutable dependencyCount: uint32
    [<DefaultValue(false)>]
    val mutable pDependencies: nativeptr<VkSubpassDependency2>
    [<DefaultValue(false)>]
...
type VkSubpassDescription2 =
    ...
    [<DefaultValue(false)>]
    val mutable pInputAttachments: nativeptr<VkAttachmentReference2>
    [<DefaultValue(false)>]
    val mutable colorAttachmentCount: uint32
    [<DefaultValue(false)>]
    val mutable pColorAttachments: nativeptr<VkAttachmentReference2>
    [<DefaultValue(false)>]
    val mutable pResolveAttachments: nativeptr<VkAttachmentReference2>
    [<DefaultValue(false)>]
    val mutable pDepthStencilAttachment: nativeptr<VkAttachmentReference2>
    [<DefaultValue(false)>]
...
type VkDescriptorSetLayoutBindingFlagsCreateInfo =
    ...
    [<DefaultValue(false)>]
    val mutable pBindingFlags: nativeptr<VkDescriptorBindingFlags>
...
type VkSamplerReductionModeCreateInfo =
    ...
    val mutable pNext: nativeint
    [<DefaultValue(false)>]
    val mutable reductionMode: VkSamplerReductionMode
...
type VkToolPurposeFlagsEXT = VkToolPurposeFlagBitsEXT
...
type VkResolveModeFlags = VkResolveModeFlagBits

type VkConditionalRenderingFlagsEXT = VkConditionalRenderingFlagBitsEXT

type VkDescriptorBindingFlags = VkDescriptorBindingFlagBits
...
type VkSemaphoreWaitFlags = VkSemaphoreWaitFlagBits

type VkAcquireProfilingLockFlagsKHR = VkAcquireProfilingLockFlagBitsKHR

type VkPerformanceCounterDescriptionFlagsKHR = VkPerformanceCounterDescriptionFlagBitsKHR
...
let VK_MAX_DRIVER_NAME_SIZE = 256
let VK_MAX_DRIVER_NAME_SIZE_KHR = VK_MAX_DRIVER_NAME_SIZE
let VK_MAX_DRIVER_INFO_SIZE = 256
let VK_MAX_DRIVER_INFO_SIZE_KHR = VK_MAX_DRIVER_INFO_SIZE
...
[<DllImport("vulkan-1.dll", CallingConvention = CallingConvention.Winapi);SuppressUnmanagedCodeSecurity>]
extern VkResult vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR(VkPhysicalDevice physicalDevice, uint32 queueFamilyIndex, uint32* pCounterCount, VkPerformanceCounterKHR* pCounters, VkPerformanceCounterDescriptionKHR* pCounterDescriptions)

[<DllImport("vulkan-1.dll", CallingConvention = CallingConvention.Winapi);SuppressUnmanagedCodeSecurity>]
extern void vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR(VkPhysicalDevice physicalDevice, VkQueryPoolPerformanceCreateInfoKHR* pPerformanceQueryCreateInfo, uint32* pNumPasses)

[<DllImport("vulkan-1.dll", CallingConvention = CallingConvention.Winapi);SuppressUnmanagedCodeSecurity>]
extern VkResult vkAcquireProfilingLockKHR(VkDevice device, VkAcquireProfilingLockInfoKHR* pInfo)

[<DllImport("vulkan-1.dll", CallingConvention = CallingConvention.Winapi);SuppressUnmanagedCodeSecurity>]
extern void vkReleaseProfilingLockKHR(VkDevice device)
...
[<UnmanagedFunctionPointer(CallingConvention.Winapi)>]
type vkGetPhysicalDeviceToolPropertiesEXT =  delegate of VkPhysicalDevice * nativeptr<uint32> * nativeptr<VkPhysicalDeviceToolPropertiesEXT> -> VkResult
...
let VK_KHR_PERFORMANCE_QUERY_SPEC_VERSION = 1
let VK_KHR_PERFORMANCE_QUERY_EXTENSION_NAME = "VK_KHR_performance_query"
...
let VK_EXT_FILTER_CUBIC_SPEC_VERSION = 3
...
let VK_KHR_SHADER_SUBGROUP_EXTENDED_TYPES_SPEC_VERSION = 1
let VK_KHR_SHADER_SUBGROUP_EXTENDED_TYPES_EXTENSION_NAME = "VK_KHR_shader_subgroup_extended_types"
...
let VK_KHR_SHADER_CLOCK_SPEC_VERSION = 1
let VK_KHR_SHADER_CLOCK_EXTENSION_NAME = "VK_KHR_shader_clock"
...
let VK_KHR_TIMELINE_SEMAPHORE_SPEC_VERSION = 2
let VK_KHR_TIMELINE_SEMAPHORE_EXTENSION_NAME = "VK_KHR_timeline_semaphore"
...
let VK_KHR_SPIRV_1_4_SPEC_VERSION = 1
let VK_KHR_SPIRV_1_4_EXTENSION_NAME = "VK_KHR_spirv_1_4"
...
let VK_KHR_SEPARATE_DEPTH_STENCIL_LAYOUTS_SPEC_VERSION = 1
let VK_KHR_SEPARATE_DEPTH_STENCIL_LAYOUTS_EXTENSION_NAME = "VK_KHR_separate_depth_stencil_layouts"
...
let VK_EXT_TOOLING_INFO_SPEC_VERSION = 1
let VK_EXT_TOOLING_INFO_EXTENSION_NAME = "VK_EXT_tooling_info"
...
let VK_KHR_BUFFER_DEVICE_ADDRESS_SPEC_VERSION = 1
let VK_KHR_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME = "VK_KHR_buffer_device_address"
...
let VK_QCOM_RENDER_PASS_TRANSFORM_SPEC_VERSION = 1
let VK_QCOM_RENDER_PASS_TRANSFORM_EXTENSION_NAME = "VK_QCOM_render_pass_transform"
...
let VK_GOOGLE_USER_TYPE_SPEC_VERSION = 1
let VK_GOOGLE_USER_TYPE_EXTENSION_NAME = "VK_GOOGLE_user_type"
let VK_NV_EXTENSION_291_SPEC_VERSION = 0
let VK_NV_EXTENSION_291_EXTENSION_NAME = "VK_NV_extension_291"
let VK_NV_EXTENSION_292_SPEC_VERSION = 0
let VK_NV_EXTENSION_292_EXTENSION_NAME = "VK_NV_extension_292"
let VK_NV_EXTENSION_293_SPEC_VERSION = 0
let VK_NV_EXTENSION_293_EXTENSION_NAME = "VK_NV_extension_293"
let VK_KHR_SHADER_NON_SEMANTIC_INFO_SPEC_VERSION = 1
let VK_KHR_SHADER_NON_SEMANTIC_INFO_EXTENSION_NAME = "VK_KHR_shader_non_semantic_info"
let VK_KHR_EXTENSION_295_SPEC_VERSION = 0
let VK_KHR_EXTENSION_295_EXTENSION_NAME = "VK_KHR_extension_295"
let VK_NV_EXTENSION_296_SPEC_VERSION = 0
let VK_NV_EXTENSION_296_EXTENSION_NAME = "VK_NV_extension_296"
let VK_KHR_EXTENSION_297_SPEC_VERSION = 0
let VK_KHR_EXTENSION_297_EXTENSION_NAME = "VK_KHR_extension_297"
let VK_EXT_EXTENSION_298_SPEC_VERSION = 0
let VK_EXT_EXTENSION_298_EXTENSION_NAME = "VK_EXT_extension_298"
let VK_KHR_EXTENSION_299_SPEC_VERSION = 0
let VK_KHR_EXTENSION_299_EXTENSION_NAME = "VK_KHR_extension_299"
let VK_KHR_EXTENSION_300_SPEC_VERSION = 0
let VK_KHR_EXTENSION_300_EXTENSION_NAME = "VK_KHR_extension_300"
let VK_NV_EXTENSION_301_SPEC_VERSION = 0
let VK_NV_EXTENSION_301_EXTENSION_NAME = "VK_NV_extension_301"
let VK_QCOM_extension_302_SPEC_VERSION = 0
let VK_QCOM_extension_302_EXTENSION_NAME = "VK_QCOM_extension_302"
let VK_QCOM_extension_303_SPEC_VERSION = 0
let VK_QCOM_extension_303_EXTENSION_NAME = "VK_QCOM_extension_303"
let VK_QCOM_extension_304_SPEC_VERSION = 0
let VK_QCOM_extension_304_EXTENSION_NAME = "VK_QCOM_extension_304"
let VK_QCOM_extension_305_SPEC_VERSION = 0
let VK_QCOM_extension_305_EXTENSION_NAME = "VK_QCOM_extension_305"
let VK_QCOM_extension_306_SPEC_VERSION = 0
let VK_QCOM_extension_306_EXTENSION_NAME = "VK_QCOM_extension_306"
let VK_QCOM_extension_307_SPEC_VERSION = 0
let VK_QCOM_extension_307_EXTENSION_NAME = "VK_QCOM_extension_307"
let VK_NV_EXTENSION_308_SPEC_VERSION = 0
let VK_NV_EXTENSION_308_EXTENSION_NAME = "VK_NV_extension_308"
let VK_KHR_EXTENSION_309_SPEC_VERSION = 0
let VK_KHR_EXTENSION_309_EXTENSION_NAME = "VK_KHR_extension_309"
let VK_QCOM_extension_310_SPEC_VERSION = 0
let VK_QCOM_extension_310_EXTENSION_NAME = "VK_QCOM_extension_310"
let VK_NV_EXTENSION_311_SPEC_VERSION = 0
let VK_NV_EXTENSION_311_EXTENSION_NAME = "VK_NV_extension_311"
let VK_EXT_EXTENSION_312_SPEC_VERSION = 0
let VK_EXT_EXTENSION_312_EXTENSION_NAME = "VK_EXT_extension_312"
let VK_EXT_EXTENSION_313_SPEC_VERSION = 0
let VK_EXT_EXTENSION_313_EXTENSION_NAME = "VK_EXT_extension_313"
